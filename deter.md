...
- POSSIBLE, questionable secondary normative priority is optimality of the technical solution
Perplexity content:
>A stylised way to capture the situation is as follows.
>- Let $C$ be the set of "citizens" (less trusted group) and $E$ the set of "experts" (more trusted group).
...
Many real-world institutions can be understood as instantiations of this template, even if they were not originally framed that way. Research on these is ongoing.
