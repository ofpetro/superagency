...
**Sub-items:**
- The decisive agent acts *before* noise enters the system: their disposition or position is fixed prior to the disturbance, which then perturbs other actors around them without altering the outcome
...
- Example: Schabowski's silence on whether the travel regulation was immediate — he did not know, so he improvised, producing an outcome neither planned nor intended
...
The decisive agent or veto-power mechanism lacks precise information, or is overwhelmed with information, either way leading it to resist taking action. This resistance may be directed against the initially predicted (escalatory) narrative — helping defuse it — or, in a more ambiguous variant, against the resolving (de-escalatory) narrative, inadvertently helping the deflation by obstructing both sides.
